        ...
        <div class="container-fluid">
          ...
          <div id="am-navbar-collapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right am-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="../assets/img/avatar3.jpg"><span class="user-name"> <?php echo $_SESSION['username']; ?></span><span class="angle-down s7-angle-down"></span></a>
